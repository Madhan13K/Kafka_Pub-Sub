...
public class ConsumerService {
    ...
    @KafkaListener(topicPartitions = {@TopicPartition(topic = AppConfig.NEWS_CREATED_TOPIC_NAME,partitions = {AppConfig.NEWS_CREATED_BRAZIL_PARTITION,AppConfig.NEWS_CREATED_INTERNATIONAL_PARTITION})},groupId = AppConfig.BACKEND_CONSUMER_GROUP)
